// import { TsTxAuctionBorrowRequest, TsTxAuctionLendRequest, TsTxTransferRequest } from '@common/ts-typeorm/account/dto/ts-req-types';
// import { ApiProperty, ApiPropertyOptional } from '@nestjs/swagger';
// import { TsTxRegisterRequest, TsTxDepositRequest, EdDSASignatureRequestType, TsTxWithdrawRequest, } from '@ts-sdk/domain/lib/ts-types/ts-req-types';
